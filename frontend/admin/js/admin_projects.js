document.addEventListener('DOMContentLoaded', () => {
    ...
    // Set to '' (empty string) if your backend is served with frontend (same domain)
// Or set to the full backend URL (e.g., 'https://your-backend-railway-url.app') if deploying separately
const API_BASE_URL = 'https://timecard-backend-production-xxxx.up.railway.app';
// const API_BASE_URL = ''; // <-- Uncomment this if all-in-one Express app!
